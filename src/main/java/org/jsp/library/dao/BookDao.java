...
public class BookDao {
    ...
    public List<Book> findByName(String name) {
        return bookRepository.findByName(name).orElseThrow(()->new NotFoundException("Book Name Doesn't match Any"));
    }

    public List<Book> findByAuthor(String author) {
        return bookRepository.findByAuthor(author).orElseThrow(()->new NotFoundException("Author Name Doesn't match Any"));
    }
